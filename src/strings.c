...
ALIGNED(4) const u8 gText_EndedWithXUnitsPowder[] = _("{PAUSE_MUSIC}{PLAY_BGM HG_SEQ_ME_LVUP}You ended up with {STR_VAR_1} units of\nsilky-smooth BERRY POWDER.{RESUME_MUSIC}\pYour total amount of BERRY POWDER\nis {STR_VAR_2}.\p");
...
const u8 gText_PokemonChannel1[] = _("{PAUSE 40}POKéMON{PAUSE 93} POKéMON\n{PAUSE 93}POKéMON CHANNEL");
